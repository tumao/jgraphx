...
import example.com.mxgraph.examples.swing.editor.EditorActions.FontStyleAction;
...
public class EditorToolBar extends JToolBar
{
	...
	public EditorToolBar(final BasicGraphEditor editor, int orientation)
	{
		...
		add(editor.bind("New", new NewAction(),
				"/example/com/mxgraph/examples/swing/images/new.gif"));
		add(editor.bind("Open", new OpenAction(),
				"/example/com/mxgraph/examples/swing/images/open.gif"));
		add(editor.bind("Save", new SaveAction(false),
				"/example/com/mxgraph/examples/swing/images/save.gif"));
